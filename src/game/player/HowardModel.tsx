  ...
  return (
    <group position={[0, -0.3, 0]}>
      ...
      <mesh castShadow position={[0, 0.3, 0]}>
        ...
        <meshToonMaterial gradientMap={getGradientMap()} color="#8a6f4a" />
      </mesh>
      {/* Porkpie hat */}
      <mesh castShadow position={[0, 0.66, 0]}>
        <cylinderGeometry args={[0.34, 0.34, 0.05, 14]} />
        <meshToonMaterial gradientMap={getGradientMap()} color="#5a4a36" />
      </mesh>
      ...
      <mesh position={[-0.09, 0.5, 0.28]}>
        ...
        <meshToonMaterial gradientMap={getGradientMap()} color="#101010" />
      </mesh>
      <mesh position={[0.09, 0.5, 0.28]}>
        <sphereGeometry args={[0.032, 8, 8]} />
        <meshToonMaterial gradientMap={getGradientMap()} color="#101010" />
      ...
      <mesh castShadow position={[0, 0.4, 0.3]}>
        ...
        <meshToonMaterial gradientMap={getGradientMap()} color="#6a5538" />
      </mesh>
      {/* Record satchel on the hip */}
      <mesh castShadow position={[-0.3, 0, 0.05]}>
        <boxGeometry args={[0.1, 0.34, 0.34]} />
        <meshToonMaterial gradientMap={getGradientMap()} color="#4a3a2a" />
      </mesh>
    </group>
  );
}
