  ...
  return (
    <group>
      ...
      <mesh castShadow position={[0, -0.35, 0]}>
        ...
        <meshToonMaterial gradientMap={getGradientMap()} color="#20241c" />
        <ToonOutline />
      </mesh>
      {/* Torso + head */}
      <mesh castShadow position={[0, 0.35, 0]}>
        <capsuleGeometry args={[0.32, 0.5, 6, 14]} />
        <meshToonMaterial gradientMap={getGradientMap()} color="#4a7a3d" />
        <ToonOutline />
      </mesh>
      {/* Top hat */}
      <mesh castShadow position={[0, 0.82, 0]}>
        <cylinderGeometry args={[0.45, 0.45, 0.06, 16]} />
        <meshToonMaterial gradientMap={getGradientMap()} color="#15161a" />
      </mesh>
